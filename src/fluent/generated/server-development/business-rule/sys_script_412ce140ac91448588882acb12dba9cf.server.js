// @fluent-module enforceEavXor;false;x_gzi_zflow/z-inflow/0.0.1/src/server/business-rules/enforce-eav-xor.ts
...
const { enforceEavXor } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/business-rules/enforce-eav-xor.ts');
enforceEavXor(current, previous);