// @fluent-module enforceEavXor;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/business-rules/enforce-eav-xor.ts
...
const { enforceEavXor } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/business-rules/enforce-eav-xor.ts');
