// @fluent-module enforceSingleAssignee;false;x_gzi_zflow/z-inflow/0.0.1/src/server/business-rules/enforce-single-assignee.ts
...
const { enforceSingleAssignee } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/business-rules/enforce-single-assignee.ts');
enforceSingleAssignee(current, previous);