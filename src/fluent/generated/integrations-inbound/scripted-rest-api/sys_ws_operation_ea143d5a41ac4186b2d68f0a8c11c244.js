// @fluent-module createStatusUpdate;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts
...
const { createStatusUpdate } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts');
