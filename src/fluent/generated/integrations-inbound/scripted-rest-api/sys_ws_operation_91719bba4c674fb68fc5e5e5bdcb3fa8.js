// @fluent-module listCustomFields;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/view-routes.ts
...
const { listCustomFields } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/view-routes.ts');
listCustomFields(request, response);