// @fluent-module createSection;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/section-routes.ts
...
const { createSection } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/section-routes.ts');
