// @fluent-module listStatusUpdates;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts
...
const { listStatusUpdates } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts');
listStatusUpdates(request, response);