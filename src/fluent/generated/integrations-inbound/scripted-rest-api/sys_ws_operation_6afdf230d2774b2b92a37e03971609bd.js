// @fluent-module deleteStatusUpdate;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts
...
const { deleteStatusUpdate } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts');
deleteStatusUpdate(request, response);