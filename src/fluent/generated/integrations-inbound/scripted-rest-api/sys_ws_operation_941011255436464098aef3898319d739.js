// @fluent-module updateTask;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/task-routes.ts
...
const { updateTask } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/task-routes.ts');
