// @fluent-module getTaskProjects;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/project-routes.ts
...
const { getTaskProjects } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/project-routes.ts');
getTaskProjects(request, response);