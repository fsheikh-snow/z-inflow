// @fluent-module listCapacityPlans;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts
...
const { listCapacityPlans } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts');
listCapacityPlans(request, response);