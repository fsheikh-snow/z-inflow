// @fluent-module getPortfolioWorkload;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts
...
const { getPortfolioWorkload } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts');
getPortfolioWorkload(request, response);