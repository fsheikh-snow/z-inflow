// @fluent-module getTaskProjects;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/task-routes.ts
...
const { getTaskProjects } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/task-routes.ts');
