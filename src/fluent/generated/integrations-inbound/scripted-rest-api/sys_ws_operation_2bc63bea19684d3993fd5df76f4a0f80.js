// @fluent-module listProjects;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/project-routes.ts
...
const { listProjects } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/project-routes.ts');
