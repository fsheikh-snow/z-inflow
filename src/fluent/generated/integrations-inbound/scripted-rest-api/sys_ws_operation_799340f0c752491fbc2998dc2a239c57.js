// @fluent-module searchGroups;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/identity-routes.ts
...
const { searchGroups } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/identity-routes.ts');
