// @fluent-module getTask;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/project-routes.ts
...
const { getTask } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/project-routes.ts');
