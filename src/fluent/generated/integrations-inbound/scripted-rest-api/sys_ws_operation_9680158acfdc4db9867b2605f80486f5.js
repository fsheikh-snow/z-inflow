// @fluent-module getPortfolioDashboard;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts
...
const { getPortfolioDashboard } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts');
getPortfolioDashboard(request, response);