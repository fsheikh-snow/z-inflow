// @fluent-module deleteSection;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/section-routes.ts
...
const { deleteSection } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/section-routes.ts');
