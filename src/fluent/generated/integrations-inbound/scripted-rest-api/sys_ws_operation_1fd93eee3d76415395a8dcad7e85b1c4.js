// @fluent-module createPortfolio;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts
...
const { createPortfolio } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts');
