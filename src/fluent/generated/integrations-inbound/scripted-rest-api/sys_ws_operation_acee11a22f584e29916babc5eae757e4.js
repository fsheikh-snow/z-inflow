// @fluent-module getTeamMembers;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts
...
const { getTeamMembers } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts');
getTeamMembers(request, response);