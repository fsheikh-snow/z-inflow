// @fluent-module getProjectSections;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/project-routes.ts
...
const { getProjectSections } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/project-routes.ts');
getProjectSections(request, response);