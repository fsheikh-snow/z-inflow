// @fluent-module upsertCustomFieldValues;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/view-routes.ts
...
const { upsertCustomFieldValues } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/view-routes.ts');
