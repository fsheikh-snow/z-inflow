// @fluent-module getProjectPortfolios;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts
...
const { getProjectPortfolios } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts');
getProjectPortfolios(request, response);