// @fluent-module getCapacityPlanGrid;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts
...
const { getCapacityPlanGrid } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts');
getCapacityPlanGrid(request, response);