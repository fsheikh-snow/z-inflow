// @fluent-module getPortfolioViewData;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts
...
const { getPortfolioViewData } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/portfolio-routes.ts');
