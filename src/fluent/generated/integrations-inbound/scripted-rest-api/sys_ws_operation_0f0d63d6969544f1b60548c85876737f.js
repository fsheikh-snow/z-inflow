// @fluent-module getPortfolioViews;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts
...
const { getPortfolioViews } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts');
getPortfolioViews(request, response);