// @fluent-module searchUsers;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/identity-routes.ts
...
const { searchUsers } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/identity-routes.ts');
