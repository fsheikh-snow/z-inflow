// @fluent-module listCustomFieldValues;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/view-routes.ts
...
const { listCustomFieldValues } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/view-routes.ts');
