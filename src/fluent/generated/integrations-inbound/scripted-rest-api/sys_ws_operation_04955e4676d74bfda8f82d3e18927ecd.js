// @fluent-module getCapacityPlanAllocations;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/capacity-routes.ts
...
const { getCapacityPlanAllocations } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/capacity-routes.ts');
getCapacityPlanAllocations(request, response);