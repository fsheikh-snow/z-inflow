// @fluent-module updateStatusUpdate;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts
...
const { updateStatusUpdate } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/status-routes.ts');
updateStatusUpdate(request, response);