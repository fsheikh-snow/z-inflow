// @fluent-module getCapacityPlanGrid;false;x_gzi_zflow/z-inflow/0.0.1/src/server/rest/capacity-routes.ts
...
const { getCapacityPlanGrid } = require('x_gzi_zflow/z-inflow/0.0.1/src/server/rest/capacity-routes.ts');
