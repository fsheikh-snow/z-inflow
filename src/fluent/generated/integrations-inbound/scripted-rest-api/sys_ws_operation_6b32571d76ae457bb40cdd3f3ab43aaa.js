// @fluent-module getPlanAllocations;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts
...
const { getPlanAllocations } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/capacity-routes.ts');
getPlanAllocations(request, response);