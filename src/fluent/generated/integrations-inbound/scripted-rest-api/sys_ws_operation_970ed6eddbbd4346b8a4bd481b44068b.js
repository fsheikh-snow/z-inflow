// @fluent-module getPortfolioViewData;false;x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts
...
const { getPortfolioViewData } = require('x_gzi_ppm/x_gzi_ppm/1.0.0/src/server/routes/portfolio-routes.ts');
getPortfolioViewData(request, response);